...
function peg$parse(input, options) {
  ...
  var peg$f23 = function(expr) { return "${" + expr.map(e => e[1]).join('') + "}"; };
  ...
  var peg$f29 = function(name, first, rest) {
  ...
  var peg$f30 = function(arg) {
  return arg;
};
  var peg$f31 = function(first, rest) { return first + rest.join(''); };
